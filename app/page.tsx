...
export default function BeatFlowLandingPage() {
 ...
 —  —  —  —  —  —  —  —  —  — Assinar Plano Pro
            ...
            <p className="text-xs text-[rgba(255,255,255,0.6)] leading-relaxed mb-6">
                <p className="text-xs text-[rgba(255,255,255,0.6)] leading-relaxed mb-6">Direcao de arte com IA, cenas generativas WebGL sob medida e experiencias imersivas exclusivas.</p>
            </p>
            ...
            <div className="flex items-start gap-2.5">
            <Check className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
                  <span><strong>Curadoria & Verificacao Oficial:</strong> Selo de autoridade e destaque no ecossistema Beat Flow</span>
            </div>
            <div className="flex items-start gap-2.5">
            <Check className="w-4 h-4 text-amber-400 shrink-0 mt-0.5" />
